...
var (
	...
	ErrRoleSearchTopicNotFound    = errors.New("role search topic not found")
	ErrRoleRecordNotFound         = errors.New("role record not found")
	ErrDuplicateActiveRoleURL     = errors.New("active role with posting url already exists")
	ErrInvalidRoleDecisionStatus  = errors.New("invalid role decision status")
	ErrInvalidRoleFreshnessStatus = errors.New("invalid role freshness status")
	ErrRoleAlreadyPromoted        = errors.New("role already promoted")
	ErrRoleSearchProviderFailed   = errors.New("role search provider failed")
)
