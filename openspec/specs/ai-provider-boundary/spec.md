# Capability: AI Provider Boundary

## Purpose

Application-layer port that isolates AI text-generation providers from domain and GraphQL code. Defines the request/response contract future AI use cases will depend on, and keeps concrete provider adapters (and their credentials/configuration) behind composition boundaries so providers can be swapped or faked in tests.
