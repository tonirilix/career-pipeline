...
Defines the containerised local development environment. The goal is to let any developer start the full stack (PostgreSQL, Go API, React/Vite frontend) with a single command and no local language tooling required beyond Docker.
