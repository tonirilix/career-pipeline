...
## Purpose
Defines a deterministic command palette that lets users navigate between workspaces, trigger creation actions, and control Pipeline saved views and filters from a single keyboard- and UI-accessible surface.
