# Capability: AI Artifact Foundation

## Purpose

Domain and persistence foundation for AI-generated artifacts (e.g., tailored resumes, cover letters, outreach messages). Stores generated content, user-edited content, approval and supersession state, and provenance metadata so future AI workflows and vector indexing can build on durable, auditable artifact records.
