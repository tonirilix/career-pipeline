# Capability: Candidate Memory Foundation

## Purpose

Domain and persistence foundation for authoritative candidate grounding context: a single active candidate profile plus granular, approvable, versionable memory records. Provides the application-layer grounding context assembly that future AI workflows will use, independent of job application data.
